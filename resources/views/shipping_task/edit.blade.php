...
<div class="col-lg-12 col-md-12">   
    ...
    {!! Form::open(array('url' => 'shipping_task/update', 'role' => 'form', 'method' => 'post', 'class' => 'form-horizontal', 'name' => 'form_shipping_task', 'files' => true, 'parsley-validate')) !!}
    ...
    <div class="panel-heading"><i class="glyphicon glyphicon-signal"></i> </div>    
      <div class="panel-body">                       
               ...
               <div class="form-group">
                ...
                <div class="col-sm-6">      
                    {!! Form::select('id_shipping_company', array('null' => 'Please select item') + $list_shipping_company, array($data->id_shipping_company),  array('class' => 'form-control valid') ) !!}
               ...
               <div class="form-group">
                ...
                <div class="col-sm-6">      
                    {!! Form::select('id_vessel', array('null' => 'Please select item') + $list_vessel, array($data->id_vessel),  array('class' => 'form-control valid') ) !!}                    
                </div>
              </div> 
               ...
               <div class="form-group">
                ...
                <div class="col-sm-4">      
                      ...
                      {!! Form::hidden('id_employee_profile', $data->id_employee_profile) !!}
                </div>
               ...
               <div class="form-group">
                ...
                <div class="col-sm-6">      
                    {!! Form::select('id_harbour_master', array('null' => 'Please select item') + $list_harbour_master, array($data->id_harbour_master),  array('class' => 'form-control valid') ) !!}                    
                </div>
              </div> 
               <div class="form-group">
                     {!! Form::label('id_certificate', 'Certificate', array('class' => 'col-sm-2 control-label')) !!}  <span class="required-input">*</span>
                <div class="col-sm-6">      
                    {!! Form::select('id_certificate', array('null' => 'Please select item') + $list_certificate, array($data->id_certificate),  array('class' => 'form-control valid') ) !!}                    
                </div>
              </div> 
               <div class="form-group">
                     {!! Form::label('date_inspection', 'Date Inspection', array('class' => 'col-sm-2 control-label')) !!}  <span class="required-input">*</span>
                <div class="col-sm-4">      
                {!! Form::text('date_inspection', ($data->date_inspection!= null? date( 'Y-m-d', strtotime($data->date_inspection)): null) , array('id' => 'date_inspection', 'class' => 'form-control input-sm  required tanggal',  'placeholder'  => 'Tanggal Mulai' )) !!}
                </div>
              </div> 
               <div class="form-group">
                     {!! Form::label('date_expired', 'Date Expired', array('class' => 'col-sm-2 control-label')) !!}  <span class="required-input">*</span>
                <div class="col-sm-4">      
                {!! Form::text('date_expired', ($data->date_expired!= null? date( 'Y-m-d', strtotime($data->date_expired)): null) , array('id' => 'date_expired', 'class' => 'form-control input-sm  required tanggal',  'placeholder'  => 'Tanggal Mulai' )) !!}
                </div>
              </div> 
               <div class="form-group">
                     {!! Form::label('location', 'Location', array('class' => 'col-sm-2 control-label')) !!}
                <div class="col-sm-6">
                {!! Form::select('location', array('null' => 'Please select item') + $list_region, array($data->location),  array('class' => 'form-control valid') ) !!}
                </div>
              </div> 
               <div class="form-group">
                     {!! Form::label('country', 'Country', array('class' => 'col-sm-2 control-label')) !!}  
                <div class="col-sm-6">      
                {!! Form::text('country', $data->country, array('id' => 'country', 'class' => 'form-control input-sm  required',  'placeholder'  => 'Country')) !!}
                </div>
              </div> 
