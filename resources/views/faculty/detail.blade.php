...
<form method="POST" action="#" accept-charset="UTF-8" role="form" class="form-horizontal" name="form_faculty" parsley-validate="parsley-validate">
    ...
    <div class="panel-heading"><i class="glyphicon glyphicon-signal"></i> </div>    
      <div class="panel-body">             
               <div class="form-group">
                ...
                <div class="col-sm-6">      
                {!! Form::select('id_university', array('null' => 'Pilih Universitas') + $list_university, array($data->id_university), array('class' => 'form-control valid', 'disabled') ) !!}
