...
<form method="POST" action="#" accept-charset="UTF-8" role="form" class="form-horizontal" name="form_harbour_grade" parsley-validate="parsley-validate">
    ...
    <div class="panel-heading"><i class="glyphicon glyphicon-signal"></i> </div>    
      <div class="panel-body">                       
               <div class="form-group">
                ...
                <div class="col-sm-6">      
                {!! Form::text('code', $data->code, array('id' => 'code', 'class' => 'form-control input-sm  required',  'maxlength'=>'50', 'readonly' => 'true' )) !!}
                </div>
              </div> 
               <div class="form-group">
