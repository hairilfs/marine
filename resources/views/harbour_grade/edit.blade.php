...
<div class="col-lg-12 col-md-12">   
    ...
    {!! Form::open(array('url' => 'harbour_grade/update', 'role' => 'form', 'method' => 'post', 'class' => 'form-horizontal', 'name' => 'form_harbour_grade', 'parsley-validate')) !!}
    ...
    <div class="panel-heading"><i class="glyphicon glyphicon-signal"></i> </div>    
      <div class="panel-body">                       
               <div class="form-group">
                ...
                <div class="col-sm-6">      
                {!! Form::text('code', $data->code, array('id' => 'code', 'class' => 'form-control input-sm  required',  'placeholder'  => 'Kode Kelas', 'maxlength'=>'50' , 'readonly')) !!}
                </div>
              </div> 
               <div class="form-group">
                     {!! Form::label('name', 'Tingkat', array('class' => 'col-sm-2 control-label')) !!}  <span class="required-input">*</span>
                <div class="col-sm-6">      
                {!! Form::text('name', $data->name, array('id' => 'name', 'class' => 'form-control input-sm  required',  'placeholder'  => 'Tingkat', 'maxlength'=>'50' )) !!}
