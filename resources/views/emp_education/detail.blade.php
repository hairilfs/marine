    ...
    <div class="panel-heading"><i class="glyphicon glyphicon-signal"></i> </div>    
      <div class="panel-body">               
               ...
               <div class="form-group">
                ...
                <div class="col-sm-6">      
                    {!! Form::select('id_education_level', array('null' => 'Please select item') + $list_education_level, array($data->id_education_level),  array('class' => 'form-control valid', 'disabled') ) !!}
                </div>
              </div> 
               <div class="form-group">
