...
<div class="col-lg-12 col-md-12">   
    ...
    {!! Form::open(array('url' => 'emp_education/update', 'role' => 'form', 'method' => 'post', 'class' => 'form-horizontal', 'name' => 'form_emp_education', 'files' => true, 'parsley-validate')) !!}
    ...
    <div class="panel-heading"><i class="glyphicon glyphicon-signal"></i> </div>    
      <div class="panel-body">                       
               <div class="form-group">
                ...
                <div class="col-sm-6">      
                    {!! Form::select('id_university', array('null' => 'Please select item') + $list_university, array($data->id_university),  array('class' => 'form-control valid') ) !!}
               ...
               <div class="form-group">
                ...
                <div class="col-sm-6">      
                    {!! Form::select('id_faculty', array('null' => 'Please select item') + $list_faculty, array($data->id_faculty),  array('class' => 'form-control valid') ) !!}
                </div>
              </div> 
               <div class="form-group">
                     {!! Form::label('id_major', 'Jurusan', array('class' => 'col-sm-2 control-label')) !!}  <span class="required-input">*</span>
                <div class="col-sm-6">      
                    {!! Form::select('id_major', array('null' => 'Please select item') + $list_major, array($data->id_major),  array('class' => 'form-control valid') ) !!}
                </div>
              </div> 
               <div class="form-group">
                     {!! Form::label('id_education_level', 'jenjang Pendidikan', array('class' => 'col-sm-2 control-label')) !!}  <span class="required-input">*</span>
                <div class="col-sm-6">      
                    {!! Form::select('id_education_level', array('null' => 'Please select item') + $list_education_level, array($data->id_education_level),  array('class' => 'form-control valid') ) !!}
                </div>
              </div> 
               <div class="form-group">
