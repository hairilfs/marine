...
<form method="POST" action="#" accept-charset="UTF-8" role="form" class="form-horizontal" name="form_training_type" parsley-validate="parsley-validate">
      ...
      <div class="panel-body">                       
              ...
              <div class="form-group">
                  <div class="col-sm-offset-2 col-sm-4">
                      <div class="checkbox">
                          <label>
                              {!! Form::checkbox('refreshment', $data->refreshment, $data->refreshment === 1? true:false, ['disabled']) !!} Revalidasi
                          </label>
                      </div>
                  </div>
              </div>
              <div class="form-group">
                  <div class="col-sm-offset-2 col-sm-4">
                      <div class="checkbox">
                          <label>
                              {!! Form::checkbox('status', $data->status, $data->status === 1? true:false, ['disabled']) !!} Is Active
                          </label>
                      </div>
                  </div>
              </div>
