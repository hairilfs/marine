...
<div class="col-lg-12 col-md-12">   
    ...
    {!! Form::open(array('url' => 'training_type/update', 'role' => 'form', 'method' => 'post', 'class' => 'form-horizontal', 'name' => 'form_training_type', 'parsley-validate')) !!}
      ...
      <div class="panel-body">                       
              ...
              <div class="form-group">
                  <div class="col-sm-offset-2 col-sm-4">
                      <div class="checkbox">
                          <label>
                              {!! Form::checkbox('refreshment', $data->refreshment, $data->refreshment === 1? true:false) !!} Revalidasi
                          </label>
                      </div>
                  </div>
              </div>
              <div class="form-group">
                  <div class="col-sm-offset-2 col-sm-4">
                      <div class="checkbox">
                          <label>
                              {!! Form::checkbox('status', $data->status, $data->status === 1? true:false) !!} Is Active
                          </label>
                      </div>
                  </div>
              </div>
