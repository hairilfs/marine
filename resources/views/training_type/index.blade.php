...
<div class="col-lg-12 col-md-12">       
    <ol class="breadcrumb">
        <li><b>Jenis Pelatihan / Diklat</b></li> 
    </ol>  
</div>
...
<section class="panel panel-default">
    <header class="panel-heading">
        <div class="row">
            ...
            <a href="{{ URL::to('training_type/add') }}" class="btn btn-success btn-sm" data-tooltip="tooltip" data-placement="top" title="" data-original-title="Tambah Data">
          ...
          <table id="main_table" class="table table-condensed">            
            ...
            @foreach($data as $item)
              <tr>
               ...
               <td>{{ ($item->refreshment==1?'Ya':'Tidak') }}</td>
               <td>{{ ($item->status==1?'Aktif':'Tidak Aktif') }}</td>
               
                <td>    
                <!--    <a href="{{ URL::to('training_type/detail', array('id' => $item->id)) }}" class="btn btn-sm btn-info" data-tooltip="tooltip" data-placement="top" title="Detail">
                        <i class="glyphicon glyphicon-eye-open"></i>
                    </a> -->
                    <a href="{{ URL::to('training_type/edit', array('id' => $item->id)) }}" class="btn btn-sm btn-success" data-tooltip="tooltip" data-placement="top" title="Edit">
                        <i class="glyphicon glyphicon-edit"></i>
                    </a>
                    <a href="{{ URL::to('training_type/delete', array('id' => $item->id)) }}" onclick=" return getConfirmation();" class="btn btn-sm btn-danger" data-tooltip="tooltip" data-placement="top" title="Hapus">
