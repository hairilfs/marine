@extends('app')
@section('title')
Detail Employee Basic Education
@endsection
@section('content')
      ...
      <div class="panel-body">               
              ...
              <div class="form-group">
                ...
                <?php if($data->id_certificate_file != null){ ?>
                  <a class="btn btn-default" href="{{ URL::to('emp_profile_basic_education/download', array('id' => $data->id_certificate_file, 'type' => 'cert')) }}"> View File </a>
                <?php } else { ?>
                Tidak ada file
                <?php } ?>
              </div>  
