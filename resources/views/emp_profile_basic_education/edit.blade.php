...
<div class="col-lg-12 col-md-12">   
    ...
    {!! Form::open(array('url' => 'emp_profile_basic_education/update', 'role' => 'form', 'method' => 'post', 'class' => 'form-horizontal', 'name' => 'form_emp_basic_education', 'files' => true, 'parsley-validate')) !!}
    ...
    <div class="panel-heading"><i class="glyphicon glyphicon-signal"></i> </div>    
      <div class="panel-body">                       
               <div class="form-group">
                ...
                <div class="col-sm-6">      
                    {!! Form::select('level_education', array('null' => 'Please select item') + $list_level_basic_education, array($data->level_education),  array('class' => 'form-control valid') ) !!}
               ...
               <div class="form-group">
                ...
                <div class="col-sm-3">      
                {!! Form::text('school_name', $data->school_name, array('id' => 'school_name', 'class' => 'form-control input-sm  required',  'placeholder'  => 'School Name')) !!}
                </div>
              </div> 
               <div class="form-group">
               ...
               <div class="form-group">
                ...
                <div class="col-sm-3">      
                {!! Form::text('location', $data->location, array('id' => 'location', 'class' => 'form-control input-sm  required',  'placeholder'  => 'Location')) !!}
                </div>
              </div> 
               <div class="form-group">
                     {!! Form::label('head_master', 'Head Master', array('class' => 'col-sm-2 control-label')) !!}  
                <div class="col-sm-3">      
                {!! Form::text('head_master', $data->head_master, array('id' => 'head_master', 'class' => 'form-control input-sm  required',  'placeholder'  => 'Head Master')) !!}
                </div>
              </div> 
