...
<div class="container-fluid">
  ...
  <div class="panel panel-default">
      ...
      <div class="panel-body">  
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                ...
                <div class="col-sm-6">      
                {!! Form::text('struct_bidang', $data->struct_bidang, array('id' => 'struct_bidang', 'class' => 'form-control input-sm  required' )) !!}
                </div>
              </div> 
               <div class="form-group">
                     {!! Form::label('struct_seksi', 'Seksi', array('class' => 'col-sm-2 control-label')) !!}  
                <div class="col-sm-6">      
                {!! Form::text('struct_seksi', $data->struct_seksi, array('id' => 'struct_seksi', 'class' => 'form-control input-sm  required' )) !!}
                </div>
              </div> 
               <div class="form-group">
             ...
             <div class="form-group">
                   {!! Form::label('status', 'Status', array('class' => 'col-sm-2 control-label')) !!}  <span class="required-input">* Diisi hanya untuk status Tidak Aktif</span>
              <div class="col-sm-3">      
                  {!! Form::select('status', array('null' => 'Pilih Status') + $list_status, array($data->status), array('class' => 'form-control valid') ) !!}            
              </div>
              <div class="col-sm-3">
                  {!! Form::select('status_desc', array('null' => 'Keterangan') + $list_status_inactive, array($data->status_desc), array('class' => 'form-control valid', 'id' => 'status_desc') ) !!}            
            </div> 
            </div>  
      </div> <!--/ Panel Body -->
    ...
    {!! Form::open(array('url' => 'employee_profile/save_appearance', 'role' => 'form', 'method' => 'post', 'class' => 'form-horizontal', 'name' => 'form_emp_appearance', 'parsley-validate')) !!}
      <div class="panel panel-default">
        <div class="panel-heading"><i class="glyphicon glyphicon-signal"></i> </div>    
          ...
          <table id="main_table_basic_education" class="table table-condensed">            
            ...
            @foreach($list_emp_basic_education as $item)
              <tr>
               ...
               <!-- <td>{{ $item->status }}</td>                -->
                <td>    
                    <a href="{{ URL::to('emp_basic_education/detail', array('id' => $item->id, 'employee_profile_id' => $data->id )) }}" class="btn btn-sm btn-info" data-tooltip="tooltip" data-placement="top" title="Detail">
                        <i class="glyphicon glyphicon-eye-open"></i>
                    </a>
                    <a href="{{ URL::to('emp_basic_education/edit', array('id' => $item->id, 'employee_profile_id' => $data->id )) }}" class="btn btn-sm btn-success" data-tooltip="tooltip" data-placement="top" title="Edit">
                        <i class="glyphicon glyphicon-edit"></i>
                    </a>
                    <a href="{{ URL::to('emp_basic_education/delete', array('id' => $item->id, 'employee_profile_id' => $data->id )) }}" onclick=" return getConfirmation();" class="btn btn-sm btn-danger" data-tooltip="tooltip" data-placement="top" title="Hapus">
...
<!--            <div class="col-md-3">              
    ...
    <header class="panel-heading">
        <div class="row">
            <div class="col-md-8 col-xs-3">                
            <a href="{{ URL::to('emp_addresses/add' , array('employee_profile_id' => $data->id) ) }}" class="btn btn-success btn-sm" data-tooltip="tooltip" data-placement="top" title="" data-original-title="Tambah Data">
            <i class="glyphicon glyphicon-plus"></i>
            </a>               
            </div>
            <div class="col-md-4 col-xs-9">
          ...
          <table id="main_table_address" class="table table-condensed">            
            ...
            @foreach($list_emp_address as $item)
              <tr>
               ...
               <!-- <td>{{ $item->status }}</td>                -->
                <td>    
                    <a href="{{ URL::to('emp_addresses/detail', array('id' => $item->id, 'employee_profile_id' => $data->id )) }}" class="btn btn-sm btn-info" data-tooltip="tooltip" data-placement="top" title="Detail">
                        <i class="glyphicon glyphicon-eye-open"></i>
                    </a>
                    <a href="{{ URL::to('emp_addresses/edit', array('id' => $item->id, 'employee_profile_id' => $data->id )) }}" class="btn btn-sm btn-success" data-tooltip="tooltip" data-placement="top" title="Edit">
                        <i class="glyphicon glyphicon-edit"></i>
                    </a>
                    <a href="{{ URL::to('emp_addresses/delete', array('id' => $item->id, 'employee_profile_id' => $data->id )) }}" onclick=" return getConfirmation();" class="btn btn-sm btn-danger" data-tooltip="tooltip" data-placement="top" title="Hapus">
                        <i class="glyphicon glyphicon-trash"></i>
                    </a>         
                </td>
              </tr>     
...
<!--            <div class="col-md-3">              
    ...
    <header class="panel-heading">
        <div class="row">
            <div class="col-md-8 col-xs-3">                
            <a href="{{ URL::to('emp_education/add' , array('employee_profile_id' => $data->id) ) }}" class="btn btn-success btn-sm" data-tooltip="tooltip" data-placement="top" title="" data-original-title="Tambah Data">
            <i class="glyphicon glyphicon-plus"></i>
            </a>               
            </div>
            <div class="col-md-4 col-xs-9">
          ...
          <table id="main_table_education" class="table table-condensed">            
            ...
            @foreach($list_emp_education as $item)
              <tr>
               ...
               <!-- <td>{{ $item->status }}</td>                -->
                <td>    
                    <a href="{{ URL::to('emp_education/detail', array('id' => $item->id, 'employee_profile_id' => $data->id )) }}" class="btn btn-sm btn-info" data-tooltip="tooltip" data-placement="top" title="Detail">
                        <i class="glyphicon glyphicon-eye-open"></i>
                    </a>
                    <a href="{{ URL::to('emp_education/edit', array('id' => $item->id, 'employee_profile_id' => $data->id )) }}" class="btn btn-sm btn-success" data-tooltip="tooltip" data-placement="top" title="Edit">
                        <i class="glyphicon glyphicon-edit"></i>
                    </a>
                    <a href="{{ URL::to('emp_education/delete', array('id' => $item->id, 'employee_profile_id' => $data->id )) }}" onclick=" return getConfirmation();" class="btn btn-sm btn-danger" data-tooltip="tooltip" data-placement="top" title="Hapus">
                        <i class="glyphicon glyphicon-trash"></i>
                    </a>         
                </td>
              </tr>     
...
<!--            <div class="col-md-3">              
    ...
    <header class="panel-heading">
        <div class="row">
            <div class="col-md-8 col-xs-3">                
            <a href="{{ URL::to('emp_training/add', array('employee_profile_id' => $data->id) )}}" class="btn btn-success btn-sm" data-tooltip="tooltip" data-placement="top" title="" data-original-title="Tambah Data">
            <i class="glyphicon glyphicon-plus"></i>
            </a>               
            </div>
            <div class="col-md-4 col-xs-9">
          ...
          <table id="main_table_training" class="table table-condensed">            
            ...
            @foreach($list_emp_training as $item)
              <tr>
               ...
               <td>{{ $item->mi_card }}</td>         
                <td>    
                    <a href="{{ URL::to('emp_training/detail', array('id' => $item->id, 'employee_profile_id' => $data->id )) }}" class="btn btn-sm btn-info" data-tooltip="tooltip" data-placement="top" title="Detail">
                        <i class="glyphicon glyphicon-eye-open"></i>
                    </a>
                    <a href="{{ URL::to('emp_training/edit', array('id' => $item->id, 'employee_profile_id' => $data->id )) }}" class="btn btn-sm btn-success" data-tooltip="tooltip" data-placement="top" title="Edit">
                        <i class="glyphicon glyphicon-edit"></i>
                    </a>
                    <a href="{{ URL::to('emp_training/delete', array('id' => $item->id, 'employee_profile_id' => $data->id )) }}" onclick=" return getConfirmation();" class="btn btn-sm btn-danger" data-tooltip="tooltip" data-placement="top" title="Hapus">
                        <i class="glyphicon glyphicon-trash"></i>
                    </a>         
                </td>
              </tr>     
...
<!--            <div class="col-md-3">              
    ...
    <header class="panel-heading">
        <div class="row">
            ...
            <a href="{{ URL::to('emp_functional_position/add', array('employee_profile_id' => $data->id) )}}" class="btn btn-success btn-sm" data-tooltip="tooltip" data-placement="top" title="" data-original-title="Tambah Data">
              <i class="glyphicon glyphicon-plus"></i>
            </a>    
            </div>
            <div class="col-md-4 col-xs-9">
            ...
            @foreach($list_emp_experience as $item)
              <tr>
               ...
               <td>{{ $item->level_position }}</td>  
                <td>    
                    <a href="{{ URL::to('emp_experience/detail', array('id' => $item->id, 'employee_profile_id' => $data->id )) }}" class="btn btn-sm btn-info" data-tooltip="tooltip" data-placement="top" title="Detail">
                        <i class="glyphicon glyphicon-eye-open"></i>
                    </a>
                    <a href="{{ URL::to('emp_experience/edit', array('id' => $item->id, 'employee_profile_id' => $data->id )) }}" class="btn btn-sm btn-success" data-tooltip="tooltip" data-placement="top" title="Edit">
                        <i class="glyphicon glyphicon-edit"></i>
                    </a>
                    <a href="{{ URL::to('emp_experience/delete', array('id' => $item->id, 'employee_profile_id' => $data->id )) }}" onclick=" return getConfirmation();" class="btn btn-sm btn-danger" data-tooltip="tooltip" data-placement="top" title="Hapus">
                        <i class="glyphicon glyphicon-trash"></i>
                    </a>         
                </td>
              </tr>     
...
<script type="text/javascript">
    $(document).ready(function(){
      ...
      var cmb_status = $("form[name=form_employee_profile]").find("#status");
      check_status($(cmb_status));

      $(cmb_status).change(function(e){
        check_status(this);
      });
    ...
    function check_status(status){
      status_desc =  $("form[name=form_employee_profile]").find("#status_desc");
      $(status_desc).attr("disabled", "disabled");
      if($(status).val() == "Not Active"){
        $(status_desc).removeAttr("disabled");
      } 
      if($(status).val() == "Active"){
        $(status_desc).val($(status_desc).find("option:first").val());
        $(status_desc).attr("disabled", "disabled");
      } 
    }
