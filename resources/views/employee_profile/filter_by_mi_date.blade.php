...
<div class="row">
  ...
  <div class="col-lg-12 col-md-12">       
      <ol class="breadcrumb">
          <li><b> Data Marine Inspector Berdasarkan Tahun Pengukuhan</b></li> 
      </ol>  
  </div>
...
<div class="row">
  <div class="col-md-4 col-xs-3">   
      <form method="POST" action="#" accept-charset="UTF-8" role="search" class="form" name="filter_by_mi_date">
           <div class="input-group">     
                 <input type="text" id="txt_year" class="form-control input-sm tanggal-year" value="{{ $year }}" placeholder="Tahun Pengukuhan" name="dd" autocomplete="off"> 
                 <input name="_token" type="hidden" value="{{ csrf_token() }}"/>
                 <span class="input-group-btn">
                      <button id="btn_filter_by_mi_year" class="btn btn-primary btn-sm" type="button"><i class="glyphicon glyphicon-search"></i> Filter</button>
                      <a href="{{ URL::to('employee_profile/filter_by_mi_date') }}" class="btn btn-primary btn-sm" type="button"><i class="glyphicon glyphicon-reser"></i> Reset</a>
                 </span>
           </div>                         
      </form>
  </div>
