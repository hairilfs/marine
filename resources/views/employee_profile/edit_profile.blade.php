  ...
  <div class="tab-content">
    ...
    <div class="row">
      ...
      <div class="col-md-12">
        ...
        {!! Form::open(array('url' => 'employee_profile/save_profile', 'role' => 'form', 'method' => 'post', 'class' => 'form-horizontal', 'name' => 'form_employee_profile','files'=> true, 'parsley-validate')) !!}
        <div class="panel panel-default">
            <div class="panel-heading">
                <a class="a_print" href="#"> <span class="glyphicon glyphicon-print"></span></a>
            </div>    
              <div class="panel-body">                       
                   ...
                   <div class="form-group">
                    ...
                    <div class="col-sm-6">      
                    {!! Form::text('npwp', $data->npwp, array('id' => 'npwp', 'class' => 'form-control input-sm  required',  'placeholder'  => 'NPWP' )) !!}
                    </div>
                  </div> 
                   <div class="form-group">
                         {!! Form::label('marital_status', 'Status Menikah', array('class' => 'col-sm-2 control-label')) !!}  
                    <div class="col-sm-6">      
                    {!! Form::text('marital_status', $data->marital_status, array('id' => 'marital_status', 'class' => 'form-control input-sm  required',  'placeholder'  => 'Status Menikah' )) !!}
                    </div>
                  </div> 
                   <div class="form-group">
                         {!! Form::label('hobby', 'Hobby', array('class' => 'col-sm-2 control-label')) !!}  
                    <div class="col-sm-6">      
                    {!! Form::text('hobby', $data->hobby, array('id' => 'hobby', 'class' => 'form-control input-sm  required',  'placeholder'  => 'Hobby' )) !!}
                    </div>
                  </div> 
                   ...
                   <div class="form-group">
                    ...
                    <div class="col-sm-4">      
                    {!! Form::text('phone1', $data->phone1, array('id' => 'phone1', 'class' => 'form-control input-sm  required',  'placeholder'  => 'No HP' )) !!}
                    </div>
                  </div> 
                   <div class="form-group">
                         {!! Form::label('phone2', 'No Telp. Rumah', array('class' => 'col-sm-2 control-label')) !!}  
                    <div class="col-sm-4">      
                    {!! Form::text('phone2', $data->phone2, array('id' => 'phone2', 'class' => 'form-control input-sm  required',  'placeholder'  => 'No Telp. Rumah' )) !!}
                    </div>
                  </div> 
                   <div class="form-group">
                         {!! Form::label('phone3', 'No Telp. Lainnya', array('class' => 'col-sm-2 control-label')) !!}  
                    <div class="col-sm-4">      
                    {!! Form::text('phone3', $data->phone3, array('id' => 'phone3', 'class' => 'form-control input-sm  required',  'placeholder'  => 'No Telp. Lainnya' )) !!}
                    </div>
                  </div> 
                     <div class="form-group">
                           {!! Form::label('email01', 'Email Kantor', array('class' => 'col-sm-2 control-label')) !!}  
                      <div class="col-sm-6">      
                      {!! Form::text('email01', $data->email01, array('id' => 'email01', 'class' => 'form-control input-sm  required',  'placeholder'  => 'Email Kantor' )) !!}
                      </div>
                    </div> 
                     <div class="form-group">
                           {!! Form::label('email02', 'Email Pribadi', array('class' => 'col-sm-2 control-label')) !!}  
                      <div class="col-sm-6">      
                      {!! Form::text('email02', $data->email02, array('id' => 'email02', 'class' => 'form-control input-sm  required',  'placeholder'  => 'Email Pribadi' )) !!}
                      </div>
                    </div> 
                     <div class="form-group">
                           {!! Form::label('id_functional', 'Jabatan  Fungsional', array('class' => 'col-sm-2 control-label')) !!}  <span class="required-input">*</span>
                      <div class="col-sm-6">                      
                      {!! Form::select('id_functional', array('null' => 'Please select item') + $list_functional_title, array($data->id_functional), array('class' => 'form-control valid', 'disabled') ) !!}
                      </div>
                    </div> 
                     <div class="form-group">
                           {!! Form::label('id_structural', 'Jabatan  Struktural', array('class' => 'col-sm-2 control-label')) !!}  <span class="required-input">*</span>
                      <div class="col-sm-6">                      
                      {!! Form::select('id_structural', array('null' => 'Please select item') + $list_structural_title, array($data->id_structural), array('class' => 'form-control valid', 'disabled') ) !!}
                      </div>
                    </div> 
                     <div class="form-group">
                     ...
                     <div class="form-group">
                      ...
                      <div class="col-sm-6">                      
                      {!! Form::select('id_grade', array('null' => 'Please select item') + $list_emp_grade, array($data->id_grade), array('class' => 'form-control valid', 'disabled') ) !!}
                      </div>
                    </div> 
                     <div class="form-group">
                           {!! Form::label('id_harbour_master', 'Wilayah  Kerja', array('class' => 'col-sm-2 control-label')) !!}  <span class="required-input">*</span>
                      <div class="col-sm-6">                      
                      {!! Form::select('id_harbour_master', array('null' => 'Please select item') + $list_harbour_master, array($data->id_harbour_master), array('class' => 'form-control valid', 'disabled') ) !!}
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-sm-6">      
                        {!! Form::textarea('description', $data->description, array('id' => 'description', 'size' => '50x3', 'class' => 'form-control input-sm '  )) !!}
                        </div>
                      </div> 
                       <div class="form-group">
    ...
    {!! Form::open(array('url' => 'employee_profile/save_profile_appearance', 'role' => 'form', 'method' => 'post', 'class' => 'form-horizontal', 'name' => 'form_emp_appearance', 'parsley-validate')) !!}
      <div class="panel panel-default">
        <div class="panel-heading">        
                <a class="a_print" href="#"> <span class="glyphicon glyphicon-print"></span></a>
        </div>    
    ...
    <div class="panel-body">
         <div class="form-group">
          ...
          <div class="col-sm-3">      
          {!! Form::text('emp_appearance_height', $emp_appearance->height, array('id' => 'emp_appearance_height', 'class' => 'form-control input-sm  required',  'placeholder'  => 'Tinggi')) !!}
         ...
         <div class="form-group">
          ...
          <div class="col-sm-3">      
          {!! Form::text('emp_appearance_weight', $emp_appearance->weight, array('id' => 'emp_appearance_weight', 'class' => 'form-control input-sm  required',  'placeholder'  => 'Berat Badan')) !!}
          </div>
        </div> 
         <div class="form-group">
               {!! Form::label('emp_appearance_hair', 'Rambut', array('class' => 'col-sm-2 control-label')) !!}  
          <div class="col-sm-5">      
          {!! Form::text('emp_appearance_hair', $emp_appearance->hair, array('id' => 'emp_appearance_hair', 'class' => 'form-control input-sm  required',  'placeholder'  => 'Rambut')) !!}
          </div>
        </div> 
         <div class="form-group">
               {!! Form::label('emp_appearance_faceshape', 'Bentuk Muka', array('class' => 'col-sm-2 control-label')) !!}  
          <div class="col-sm-5">      
          {!! Form::text('emp_appearance_faceshape', $emp_appearance->facial_shape, array('id' => 'emp_appearance_faceshape', 'class' => 'form-control input-sm  required',  'placeholder'  => 'Bentuk Muka')) !!}
          </div>
        </div> 
         <div class="form-group">
               {!! Form::label('emp_appearance_skin_color', 'Warna Kulit', array('class' => 'col-sm-2 control-label')) !!}  
          <div class="col-sm-5">      
          {!! Form::text('emp_appearance_skin_color', $emp_appearance->skin_color, array('id' => 'emp_appearance_skin_color', 'class' => 'form-control input-sm  required',  'placeholder'  => 'Warna Kulit')) !!}
          </div>
        </div> 
         <div class="form-group">
               {!! Form::label('emp_appearance_blood_type', 'Blood Type', array('class' => 'col-sm-2 control-label')) !!}  
          <div class="col-sm-5">      
          {!! Form::text('emp_appearance_blood_type', $emp_appearance->blood_type, array('id' => 'emp_appearance_blood_type', 'class' => 'form-control input-sm  required',  'placeholder'  => 'Blood Type')) !!}
          </div>
        </div> 
         <div class="form-group">
               {!! Form::label('emp_appearance_distinguishable', 'Ciri-Ciri Khas', array('class' => 'col-sm-2 control-label')) !!}  
          <div class="col-sm-8">      
          {!! Form::text('emp_appearance_distinguishable', $emp_appearance->distinguishable, array('id' => 'emp_appearance_distinguishable', 'class' => 'form-control input-sm  required',  'placeholder'  => 'Ciri-Ciri Khas')) !!}
          </div>
        </div> 
         <div class="form-group">
               {!! Form::label('emp_appearance_body_part_defect','Cacat Tubuh', array('class' => 'col-sm-2 control-label')) !!}  
          <div class="col-sm-8">      
          {!! Form::text('emp_appearance_body_part_defect', $emp_appearance->body_part_defect, array('id' => 'emp_appearance_body_part_defect', 'class' => 'form-control input-sm  required',  'placeholder'  => 'Cacat Tubuh')) !!}
          </div>
        </div> 
    ...
    <header class="panel-heading">    
        <div class="row">
            ...
            <a href="{{ URL::to('emp_profile_basic_education/add' , array('employee_profile_id' => $data->id) ) }}" class="btn btn-success btn-sm" data-tooltip="tooltip" data-placement="top" title="" data-original-title="Tambah Data">
          ...
          <table id="main_table_basic_education" class="table table-condensed">            
            <thead>
              <tr>
                <th class="header">No</th>                
                    ...
                    <!-- <th>Status</th>                    -->
                <th class="red header" align="right" width="130">Aksi</th>
              </tr>
            </thead>           
            <tbody>       
            <?php  $i=1; ?>      
            @foreach($list_emp_basic_education as $item)
              <tr>
               ...
               <!-- <td>{{ $item->status }}</td>                -->
                <td>    
                    <a href="{{ URL::to('emp_profile_basic_education/detail', array('id' => $item->id, 'employee_profile_id' => $data->id )) }}" class="btn btn-sm btn-info" data-tooltip="tooltip" data-placement="top" title="Detail">
                        <i class="glyphicon glyphicon-eye-open"></i>
                    </a>
                    <a href="{{ URL::to('emp_profile_basic_education/edit', array('id' => $item->id, 'employee_profile_id' => $data->id )) }}" class="btn btn-sm btn-success" data-tooltip="tooltip" data-placement="top" title="Edit">
                        <i class="glyphicon glyphicon-edit"></i>
                    </a>
                    <a href="{{ URL::to('emp_profile_basic_education/delete', array('id' => $item->id, 'employee_profile_id' => $data->id )) }}" onclick=" return getConfirmation();" class="btn btn-sm btn-danger" data-tooltip="tooltip" data-placement="top" title="Hapus">
...
<!--            <div class="col-md-3">              
    ...
    <header class="panel-heading">
        <div class="row">
            <div class="col-md-8 col-xs-3">                
            <a class="a_print" href="#" style="padding-right: 20px;"> <span class="glyphicon glyphicon-print"></span></a>
            <a href="{{ URL::to('emp_profile_addresses/add' , array('employee_profile_id' => $data->id) ) }}" class="btn btn-success btn-sm" data-tooltip="tooltip" data-placement="top" title="" data-original-title="Tambah Data">
            <i class="glyphicon glyphicon-plus"></i>
            </a>               
            </div>
            <div class="col-md-4 col-xs-9">
          ...
          <table id="main_table_address" class="table table-condensed">            
            ...
            @foreach($list_emp_address as $item)
              <tr>
               ...
               <!-- <td>{{ $item->status }}</td>                -->
                <td>    
                    <a href="{{ URL::to('emp_profile_addresses/detail', array('id' => $item->id, 'employee_profile_id' => $data->id )) }}" class="btn btn-sm btn-info" data-tooltip="tooltip" data-placement="top" title="Detail">
                        <i class="glyphicon glyphicon-eye-open"></i>
                    </a>
                    <a href="{{ URL::to('emp_profile_addresses/edit', array('id' => $item->id, 'employee_profile_id' => $data->id )) }}" class="btn btn-sm btn-success" data-tooltip="tooltip" data-placement="top" title="Edit">
                        <i class="glyphicon glyphicon-edit"></i>
                    </a>
                    <a href="{{ URL::to('emp_profile_addresses/delete', array('id' => $item->id, 'employee_profile_id' => $data->id )) }}" onclick=" return getConfirmation();" class="btn btn-sm btn-danger" data-tooltip="tooltip" data-placement="top" title="Hapus">
                        <i class="glyphicon glyphicon-trash"></i>
                    </a>         
                </td>
              </tr>     
...
<!--            <div class="col-md-3">              
    ...
    <header class="panel-heading">
        <div class="row">
            <div class="col-md-8 col-xs-3">                
            <a class="a_print" href="#" style="padding-right: 20px;"> <span class="glyphicon glyphicon-print"></span></a>
            <a href="{{ URL::to('emp_profile_education/add' , array('employee_profile_id' => $data->id) ) }}" class="btn btn-success btn-sm" data-tooltip="tooltip" data-placement="top" title="" data-original-title="Tambah Data">
            <i class="glyphicon glyphicon-plus"></i>
            </a>               
            </div>
            <div class="col-md-4 col-xs-9">
          ...
          <table id="main_table_education" class="table table-condensed">            
            ...
            @foreach($list_emp_education as $item)
              <tr>
               ...
               <!-- <td>{{ $item->status }}</td>                -->
                <td>    
                    <a href="{{ URL::to('emp_profile_education/detail', array('id' => $item->id, 'employee_profile_id' => $data->id )) }}" class="btn btn-sm btn-info" data-tooltip="tooltip" data-placement="top" title="Detail">
                        <i class="glyphicon glyphicon-eye-open"></i>
                    </a>
                    <a href="{{ URL::to('emp_profile_education/edit', array('id' => $item->id, 'employee_profile_id' => $data->id )) }}" class="btn btn-sm btn-success" data-tooltip="tooltip" data-placement="top" title="Edit">
                        <i class="glyphicon glyphicon-edit"></i>
                    </a>
                    <a href="{{ URL::to('emp_profile_education/delete', array('id' => $item->id, 'employee_profile_id' => $data->id )) }}" onclick=" return getConfirmation();" class="btn btn-sm btn-danger" data-tooltip="tooltip" data-placement="top" title="Hapus">
                        <i class="glyphicon glyphicon-trash"></i>
                    </a>         
                </td>
              </tr>     
...
<!--            <div class="col-md-3">              
    ...
    <header class="panel-heading">
        <div class="row">
            <div class="col-md-8 col-xs-3">                
            <a class="a_print" href="#" style="padding-right: 20px;"> <span class="glyphicon glyphicon-print"></span></a>
            <a href="{{ URL::to('emp_profile_training/add', array('employee_profile_id' => $data->id) )}}" class="btn btn-success btn-sm" data-tooltip="tooltip" data-placement="top" title="" data-original-title="Tambah Data">
            <i class="glyphicon glyphicon-plus"></i>
            </a>               
            </div>
            <div class="col-md-4 col-xs-9">
          ...
          <table id="main_table_training" class="table table-condensed">            
            <thead>
              <tr>
                <th class="header">No</th>                
                    ...
                    <th>No MI Card</th>                   
                <th class="red header" align="right" width="150">Aksi</th>
              </tr>
            </thead>           
            <tbody>       
            <?php  $i=1; ?>      
            @foreach($list_emp_training as $item)
              <tr>
               ...
               <td>{{ $item->mi_card }}</td>         
                <td>    
                    <a href="{{ URL::to('emp_profile_training/detail', array('id' => $item->id, 'employee_profile_id' => $data->id )) }}" class="btn btn-sm btn-info" data-tooltip="tooltip" data-placement="top" title="Detail">
                        <i class="glyphicon glyphicon-eye-open"></i>
                    </a>
                    <a href="{{ URL::to('emp_profile_training/edit', array('id' => $item->id, 'employee_profile_id' => $data->id )) }}" class="btn btn-sm btn-success" data-tooltip="tooltip" data-placement="top" title="Edit">
                        <i class="glyphicon glyphicon-edit"></i>
                    </a>
                    <a href="{{ URL::to('emp_profile_training/delete', array('id' => $item->id, 'employee_profile_id' => $data->id )) }}" onclick=" return getConfirmation();" class="btn btn-sm btn-danger" data-tooltip="tooltip" data-placement="top" title="Hapus">
                        <i class="glyphicon glyphicon-trash"></i>
                    </a>         
                </td>
              </tr>     
...
<!--            <div class="col-md-3">              
    ...
    <header class="panel-heading">
        <div class="row">
            <div class="col-md-8 col-xs-3">                
            <a class="a_print" href="#" style="padding-right: 20px;"> <span class="glyphicon glyphicon-print"></span></a>
            <a href="{{ URL::to('emp_profile_experience/add', array('employee_profile_id' => $data->id) )}}" class="btn btn-success btn-sm" data-tooltip="tooltip" data-placement="top" title="" data-original-title="Tambah Data">
            <i class="glyphicon glyphicon-plus"></i>
            </a>               
            </div>
            <div class="col-md-4 col-xs-9">
            ...
            @foreach($list_emp_experience as $item)
              <tr>
               ...
               <td>{{ $item->level_position }}</td>  
                <td>    
                    <a href="{{ URL::to('emp_profile_experience/detail', array('id' => $item->id, 'employee_profile_id' => $data->id )) }}" class="btn btn-sm btn-info" data-tooltip="tooltip" data-placement="top" title="Detail">
                        <i class="glyphicon glyphicon-eye-open"></i>
                    </a>
                    <a href="{{ URL::to('emp_profile_experience/edit', array('id' => $item->id, 'employee_profile_id' => $data->id )) }}" class="btn btn-sm btn-success" data-tooltip="tooltip" data-placement="top" title="Edit">
                        <i class="glyphicon glyphicon-edit"></i>
                    </a>
                    <a href="{{ URL::to('emp_profile_experience/delete', array('id' => $item->id, 'employee_profile_id' => $data->id )) }}" onclick=" return getConfirmation();" class="btn btn-sm btn-danger" data-tooltip="tooltip" data-placement="top" title="Hapus">
                        <i class="glyphicon glyphicon-trash"></i>
                    </a>         
                </td>
              </tr>     
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
      ...
      $(".a_print").click(function(e){
        window.open("{{ URL::to('employee_profile/print_profile_drh') }}");
      });
