...
<div class="row">
  ...
  <div class="col-lg-12 col-md-12">       
      <ol class="breadcrumb">
          <li><b>Data Marine Inspector Berdasarkan Penempatan</b></li> 
      </ol>  
  </div>
  ...
  <div class="col-md-5 col-xs-3">   
      <form method="POST" action="#" accept-charset="UTF-8" role="search" class="form" name="filter_by_graduate_date">
           <div class="input-group">     
                    {!! Form::select('id_harbour_master', array('null' => 'Pilih Unit Kerja') + $list_harbour_master, $harbour_master_id, array('class' => 'form-control valid', 'id' => 'id_harbour_master' ) ) !!}
                 ...
                 <span class="input-group-btn">
                      ...
                      <a href="{{ URL::to('employee_profile/filter_by_harbour') }}" class="btn btn-primary btn-sm" type="button"><i class="glyphicon glyphicon-reser"></i> Reset</a>
                 </span>
           </div>                         
      </form>
  </div>
...
var selectedYear = null;
    ...
    // } );
      ...
      var table = $("#main_table").dataTable({
        "bAutoWidth": false,
        "columns": [ { "width": "25px" }, { "width": "80px" }, { "width": "150px" }, { "width": "80px" }, { "width": "80px" }, { "width": "80px" }, { "width": "80px" }, { "width": "80px" }, { "width": "80px" }, { "width": "80px" }, { "width": "80px" }, { "width": "80px" }, { "width": "80px" }, { "width": "80px" }, { "width": "80px" }, { "width": "80px" }, { "width": "80px" }, { "width": "80px" }, { "width": "80px" }, { "width": "80px" }, { "width": "80px" }, { "width": "80px" }, { "width": "80px" }, { "width": "80px" }, { "width": "80px" }, { "width": "120px" } ],
      ...
      $("#btn_filter_by_graduate_year").click(function(e){
        var selected_val = $("#id_harbour_master").find('option:selected').val();
        if(selected_val == undefined) selected_val = 0;
        window.location = '{{ URL::to("employee_profile/filter_by_harbour") }}'+'/'+ selected_val ;
      });
