...
<div class="col-lg-12 col-md-12">   
    ...
    {!! Form::open(array('url' => 'emp_training/save', 'role' => 'form', 'method' => 'post', 'class' => 'form-horizontal', 'name' => 'form_emp_training', 'files'=> true, 'parsley-validate')) !!}
    ...
    <div class="panel-heading"><i class="glyphicon glyphicon-signal"></i> </div>    
      <div class="panel-body">
               <div class="form-group">
                ...
                <div class="col-sm-6">      
                    {!! Form::select('id_training', array('null' => 'Please select item') + $list_training_type, Input::old('id_training'), array('class' => 'form-control valid') ) !!}
