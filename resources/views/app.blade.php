...
<html lang="en">
  <head>
    ...
    <link href="{{ asset('/content/css/bootstrap-tagsinput.css') }}" rel="stylesheet" type="text/css">
  ...
  <body>
    ...
    <div class="navbar-default navbar-static-side" role="navigation">
      <div class="sidebar-collapse">
        <ul class="nav" id="side-menu">
          <li>
            <a href="#"><img class="fa" src="{{ asset('/content/img/user.png') }}" height="15"/>&nbsp;</i>User Management<span class="fa arrow"></span></a>
            ...
            <ul class="nav nav-second-level">
              <li>
                ...
                <ul class="nav nav-third-level">
                  ...
                  <li>
                    <a  href="{{ URL::to('/emp_grade') }}" >Pangkat</a>
                  </li>
				  <li>
                    <a  href="{{ URL::to('/emp_grade') }}" >Golongan</a>
                  </li>
                </ul>
              </li>
              <li>
              ...
              <li>
                ...
                <ul class="nav nav-third-level">
                  ...
                  <li>
                    <a  href="{{ URL::to('/training_type') }}" >Jenis Diklat</a>
                  </li>
				  <li>
                    <a  href="{{ URL::to('/training_type') }}" >Training</a>
                  </li>
                </ul>
              </li>
              <!-- <li>
          ...
          <li>
            <a href="{{ URL::to('/employee_profile') }}"><img class="fa" src="{{ asset('/content/img/mi.png') }}" height="15"/>&nbsp;</i>Marine Inspector</a>
          </li>
          <li>
            <a href="#"><img class="fa" src="{{ asset('/content/img/desktop.png') }}" height="15"/>&nbsp;</i>Information System<span class="fa arrow"></span></a>
          ...
          <!--<li>
            <a href="#"><img class="fa" src="{{ asset('/content/img/check.png') }}" height="15"/>&nbsp;</i>Pemeriksaan<span class="fa arrow"></span></a>
            <ul class="nav nav-second-level">
              <li>
          ...
          <li>
            <a href="#"><img class="fa" src="{{ asset('/content/img/map.ico') }}" height="15"/>&nbsp;</i>Peta Marine Inspector<span class="fa arrow"></span></a>
            <ul class="nav nav-second-level">
              <li>
          ...
          <li>
            <a  href="{{ URL::to('/email') }}">
            <img class="fa" src="{{ asset('/content/img/email.png') }}" height="15"/>&nbsp;</i>Email</a>
          </li>
          <li>
            <a  href="{{ URL::to('/notification') }}">
            <img class="fa" src="{{ asset('/content/img/bell.png') }}" height="15"/>&nbsp;</i>Notification</a>
          </li>
          <li>
    ...
    <?php
        ...
        } elseif (Auth::user()->roles->name == "pimpinan"){
    ...
    <div class="navbar-default navbar-static-side" role="navigation">
      <div class="sidebar-collapse">
        <ul class="nav" id="side-menu">
          <li>
            <a href="#"><img class="fa" src="{{ asset('/content/img/mi.png') }}" height="15"/>&nbsp;</i>Marine Inspector<span class="fa arrow"></span></a>
