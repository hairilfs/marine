...
<div class="col-lg-12 col-md-12">   
    ...
    {!! Form::open(array('url' => 'functional_title/update', 'role' => 'form', 'method' => 'post', 'class' => 'form-horizontal', 'name' => 'form_functional_title', 'parsley-validate')) !!}
    ...
    <div class="panel-heading"><i class="glyphicon glyphicon-signal"></i> </div>    
      <div class="panel-body">                       
               ...
               <div class="form-group">
                ...
                <div class="col-sm-6">      
                {!! Form::select('upper_id', array('null' => 'Pilih Upper Id') + $list_functional_title, array($data->upper_id), array('class' => 'form-control valid') ) !!}
                </div>
              </div> 
               <div class="form-group">
