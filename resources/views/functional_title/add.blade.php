...
<div class="col-lg-12 col-md-12">   
    <ol class="breadcrumb"><li><a href="{{ URL::to('functional_title/') }}"> 
      <i class="fa fa-home"></i> Jabatan Fungsional</a></li> 
    ...
    {!! Form::open(array('url' => 'functional_title/save', 'role' => 'form', 'method' => 'post', 'class' => 'form-horizontal', 'name' => 'form_functional_title', 'parsley-validate')) !!}
    ...
    <div class="panel-heading"><i class="glyphicon glyphicon-signal"></i> </div>    
      <div class="panel-body">
               ...
               <div class="form-group">
                ...
                <div class="col-sm-6">      
                {!! Form::text('level', '', array('id' => 'level', 'class' => 'form-control input-sm  required',  'placeholder'  => 'Level'  )) !!}
                </div>
              </div> 
               <div class="form-group">
                     {!! Form::label('upper_id', 'Upper Id', array('class' => 'col-sm-2 control-label')) !!}  
                <div class="col-sm-6">      
                {!! Form::select('upper_id', array('null' => 'Pilih Upper Id') + $list_functional_title, Input::old('list_functional_title'), array('class' => 'form-control valid') ) !!}
                </div>
              </div> 
               <div class="form-group">
                     {!! Form::label('upper_level', 'Upper Level', array('class' => 'col-sm-2 control-label')) !!}  
                <div class="col-sm-6">      
                {!! Form::text('upper_level', '', array('id' => 'upper_level', 'class' => 'form-control input-sm  required',  'placeholder'  => 'Upper Level'  )) !!}
                </div>
              </div> 
               <div class="form-group">
    ...
    <div class="panel-footer">   
          <div class="row"> 
              <div class="col-md-10 col-sm-12 col-md-offset-2 col-sm-offset-0">
                   <a href="{{ URL::to('functional_title') }}" class="btn btn-default">
