...
<div class="col-lg-12 col-md-12">   
    ...
    {!! Form::open(array('url' => 'vessel/update', 'role' => 'form', 'method' => 'post', 'class' => 'form-horizontal', 'name' => 'form_vessel', 'parsley-validate')) !!}
    ...
    <div class="panel-heading"><i class="glyphicon glyphicon-signal"></i> </div>    
      <div class="panel-body">                       
               <div class="form-group">
                ...
                <div class="col-sm-6">      
                {!! Form::text('vessel_name', $data->vessel_name, array('id' => 'vessel_name', 'class' => 'form-control input-sm  required',  'placeholder'  => 'Nama Vessel', 'maxlength'=>'50' )) !!}
               ...
               <div class="form-group">
                ...
                <div class="col-sm-6">      
                {!! Form::text('vessel_type', $data->vessel_type, array('id' => 'vessel_type', 'class' => 'form-control input-sm  required',  'placeholder'  => 'Type', 'maxlength'=>'50' )) !!}
                </div>
              </div> 
               <div class="form-group">
                     {!! Form::label('call_sign', 'Call Sign', array('class' => 'col-sm-2 control-label')) !!}  <span class="required-input">*</span>
                <div class="col-sm-6">      
                {!! Form::text('call_sign', $data->call_sign, array('id' => 'call_sign', 'class' => 'form-control input-sm  required',  'placeholder'  => 'Call Sign', 'maxlength'=>'50' )) !!}
                </div>
              </div> 
               <div class="form-group">
                     {!! Form::label('imo_number', 'IMO Number', array('class' => 'col-sm-2 control-label')) !!}  <span class="required-input">*</span>
                <div class="col-sm-6">      
                {!! Form::text('imo_number', $data->imo_number, array('id' => 'imo_number', 'class' => 'form-control input-sm  required',  'placeholder'  => 'IMO Number', 'maxlength'=>'150' )) !!}
                </div>
              </div> 
               <div class="form-group">
                     {!! Form::label('mmsi_number', 'MMSI Number', array('class' => 'col-sm-2 control-label')) !!}  <span class="required-input">*</span>
                <div class="col-sm-6">      
                {!! Form::text('mmsi_number', $data->mmsi_number, array('id' => 'mmsi_number', 'class' => 'form-control input-sm  required',  'placeholder'  => 'MMSI NUmber', 'maxlength'=>'50' )) !!}
                </div>
              </div> 
               <div class="form-group">
                     {!! Form::label('certificate', 'Certificate', array('class' => 'col-sm-2 control-label')) !!}  
                <div class="col-sm-6">      
                {!! Form::text('certificate', $data->certificate, array('id' => 'certificate', 'class' => 'form-control input-sm  required',  'placeholder'  => 'Certificate', 'maxlength'=>'100' )) !!}
                </div>
              </div> 
               <div class="form-group">
