...
<div class="col-lg-12 col-md-12">   
    ...
    {!! Form::open(array('url' => 'structural_title/save', 'role' => 'form', 'method' => 'post', 'class' => 'form-horizontal', 'name' => 'form_structural_title', 'parsley-validate')) !!}
    ...
    <div class="panel-heading"><i class="glyphicon glyphicon-signal"></i> </div>    
      <div class="panel-body">
               ...
               <div class="form-group">
                ...
                <div class="col-sm-6">      
                {!! Form::select('upper_id', array('null' => 'Pilih Upper Id') + $list_structural_title, Input::old('list_structural_title'), array('class' => 'form-control valid') ) !!}
                </div>
              </div> 
               <div class="form-group">
