...
<div class="col-lg-12 col-md-12">   
    ...
    {!! Form::open(array('url' => 'emp_profile_training/save', 'role' => 'form', 'method' => 'post', 'class' => 'form-horizontal', 'name' => 'form_emp_training', 'files'=> true, 'parsley-validate')) !!}
    ...
    <div class="panel-heading"><i class="glyphicon glyphicon-signal"></i> </div>    
      <div class="panel-body">
               <div class="form-group">
                ...
                <div class="col-sm-6">      
                    {!! Form::select('id_training', array('null' => 'Pilih Jenis Training / Diklat') + $list_training_type, Input::old('id_training'), array('class' => 'form-control valid') ) !!}
               ...
               <div class="form-group">
                ...
                <div class="col-sm-3">      
                {!! Form::text('date_taken_from', '', array('id' => 'date_taken_from', 'class' => 'form-control input-sm  required tanggal',  'placeholder'  => 'Tanggal Mulai' )) !!}
                </div>
              </div> 
               <div class="form-group">
                     {!! Form::label('date_taken_to', 'Tanggal Selesai', array('class' => 'col-sm-2 control-label')) !!}  <span class="required-input">*</span>
                <div class="col-sm-3">      
                {!! Form::text('date_taken_to', '', array('id' => 'date_taken_to', 'class' => 'form-control input-sm  required tanggal',  'placeholder'  => 'Tanggal Selesai')) !!}
                </div>
              </div> 
               <div class="form-group">
               ...
               <div class="form-group">
                ...
                <div class="col-sm-6">      
                {!! Form::text('certificate_no', '', array('id' => 'certificate_no', 'class' => 'form-control input-sm  required',  'placeholder'  => 'No  Sertifikasi')) !!}
                </div>
              </div> 
               <div class="form-group mi-mark">
                     {!! Form::label('mi_card', 'Kartu MI', array('class' => 'col-sm-2 control-label')) !!}  
                <div class="col-sm-6">      
                {!! Form::text('mi_card', '', array('id' => 'mi_card', 'class' => 'form-control input-sm  required',  'placeholder'  => 'kartu MI')) !!}
                </div>
              </div> 
               <div class="form-group mi-mark">
                     {!! Form::label('mi_date', 'Tanggal Pengukuhan', array('class' => 'col-sm-2 control-label')) !!}  
                <div class="col-sm-3">      
                {!! Form::text('mi_date', '', array('id' => 'mi_date', 'class' => 'form-control input-sm  required tanggal',  'placeholder'  => 'Tanggal Pengukuhan')) !!}
                </div>
              </div> 
              <div class="form-group">
              ...
              <div class="form-group mi-mark">
                   {!! Form::label('mi_card_file', 'Upload Kartu MI', array('class' => 'col-sm-2 control-label')) !!}   <span class="required-input">* Max size 2 MB.</span>
                <div class="col-sm-3">      
               ...
               <div class="form-group">
                ...
                <div class="col-sm-6">      
                {!! Form::text('location', '', array('id' => 'location', 'class' => 'form-control input-sm  required',  'placeholder'  => 'Lokasi')) !!}
                </div>
              </div> 
               <div class="form-group">
