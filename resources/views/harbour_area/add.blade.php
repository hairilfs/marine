...
<div class="col-lg-12 col-md-12">   
    ...
    {!! Form::open(array('url' => 'harbour_area/save', 'role' => 'form', 'method' => 'post', 'class' => 'form-horizontal', 'name' => 'form_harbour_area', 'parsley-validate')) !!}
    ...
    <div class="panel-heading"><i class="glyphicon glyphicon-signal"></i> </div>    
      <div class="panel-body">
               <div class="form-group">
                ...
                <div class="col-sm-6">      
                {!! Form::text('name', '', array('id' => 'name', 'class' => 'form-control input-sm  required',  'placeholder'  => 'Nama Provinsi', 'maxlength'=>'50' )) !!}
                </div>
              </div> 
               <div class="form-group">
