...
<div class="col-lg-12 col-md-12">   
    ...
    {!! Form::open(array('url' => 'harbour_master/save', 'role' => 'form', 'method' => 'post', 'class' => 'form-horizontal', 'name' => 'form_harbour_master', 'parsley-validate')) !!}
    ...
    <div class="panel-heading"><i class="glyphicon glyphicon-signal"></i> </div>    
      <div class="panel-body">
               <div class="form-group">
                ...
                <div class="col-sm-6">      
                    {!! Form::select('id_harbour_area', array('null' => 'Pilih Provinsi') + $list_harbour_area, Input::old('id_harbour_area'), array('class' => 'form-control valid') ) !!}
                </div>
              </div> 
               <div class="form-group">
                     {!! Form::label('name', 'Nama Unit Kerja', array('class' => 'col-sm-2 control-label')) !!}  <span class="required-input">*</span>
                <div class="col-sm-6">      
                {!! Form::text('name', '', array('id' => 'name', 'class' => 'form-control input-sm  required',  'placeholder'  => 'Nama Unit Kerja', 'maxlength'=>'250' )) !!}
                </div>
              </div> 
               <div class="form-group">
               ...
               <div class="form-group">
                ...
                <div class="col-sm-6">      
                {!! Form::text('phone2', '', array('id' => 'phone2', 'class' => 'form-control input-sm  required',  'placeholder'  => 'Telepon 2' )) !!}
                </div>
              </div> 
               <div class="form-group">
                     {!! Form::label('phone3', 'Fax', array('class' => 'col-sm-2 control-label')) !!}  
                <div class="col-sm-6">      
                {!! Form::text('phone3', '', array('id' => 'phone3', 'class' => 'form-control input-sm  required',  'placeholder'  => 'Fax' )) !!}
                </div>
              </div> 
               <div class="form-group">
               ...
               <div class="form-group">
                ...
                <div class="col-sm-6">      
                {!! Form::select('id_grade', array('null' => 'Pilih Kelas Unit Kerja') + $list_harbour_grade, Input::old('id_grade'), array('class' => 'form-control valid') ) !!}
                </div>
              </div> 
               <div class="form-group">
