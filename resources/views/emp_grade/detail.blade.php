...
<div class="col-lg-12 col-md-12">   
    <ol class="breadcrumb"><li><a href="{{ URL::to('emp_grade/') }}"> 
      <i class="fa fa-home"></i> Pangkat & Golongan</a></li> 
      <li><b>Detail</b></li> 
    </ol>  
  </div>
...
<form method="POST" action="#" accept-charset="UTF-8" role="form" class="form-horizontal" name="form_emp_grade" parsley-validate="parsley-validate">
