...
{!! Form::open(array('url' => 'user/save', 'role' => 'form', 'method' => 'post', 'class' => 'form-horizontal', 'name' => 'form_user', 'parsley-validate')) !!}
    ...
    <div class="panel-heading"><i class="glyphicon glyphicon-signal"></i> </div>    
      <div class="panel-body">
              <div class="form-group">
                ...
                <div class="col-sm-4">      
                {!! Form::text('username', '', array('id' => 'username', 'class' => 'form-control input-sm  required',  'placeholder'  => 'Username', 'maxlength'=>'50' )) !!}
                </div>
              </div>
              <div class="form-group">
                 {!! Form::label('email', 'Email', array('class' => 'col-sm-2 control-label')) !!}  <span class="required-input">*</span>
                <div class="col-sm-4">      
                {!! Form::text('email', '', array('id' => 'email', 'class' => 'form-control input-sm  required',  'placeholder'  => 'Email', 'maxlength'=>'150' )) !!}
                </div>
              </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    {!! Form::label('password_confirmation', 'New Password', array('class' => 'col-sm-2 control-label')) !!}
                    <div class="col-sm-4">
               ...
               <div class="form-group">
                ...
                <div class="col-sm-4">      
                {!! Form::select('id_role', array('null' => 'Pilih Role') + $list_role, Input::old('id_role'), array('class' => 'form-control valid') ) !!}
                </div>
              </div> 
               <div class="form-group">
