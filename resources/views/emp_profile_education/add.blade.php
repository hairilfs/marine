...
<div class="col-lg-12 col-md-12">   
    ...
    {!! Form::open(array('url' => 'emp_profile_education/save', 'role' => 'form', 'method' => 'post', 'class' => 'form-horizontal', 'name' => 'form_emp_education', 'files'=> true, 'parsley-validate')) !!}
    ...
    <div class="panel-heading"><i class="glyphicon glyphicon-signal"></i> </div>    
      <div class="panel-body">
               <div class="form-group">
                ...
                <div class="col-sm-6">      
                    {!! Form::select('id_university', array('null' => 'Pilih Universitas') + $list_university, Input::old('id_university'), array('class' => 'form-control valid') ) !!}
               ...
               <div class="form-group">
                ...
                <div class="col-sm-6">      
                    {!! Form::select('id_faculty', array('null' => 'Pilih Fakultas') + $list_faculty, Input::old('id_faculty'), array('class' => 'form-control valid') ) !!}
                </div>
              </div> 
               <div class="form-group">
                     {!! Form::label('id_major', 'Jurusan', array('class' => 'col-sm-2 control-label')) !!}  <span class="required-input">*</span>
                <div class="col-sm-6">      
                    {!! Form::select('id_major', array('null' => 'Pilih Jurusan') + $list_major, Input::old('id_major'), array('class' => 'form-control valid') ) !!}
                </div>
              </div> 
               <div class="form-group">
                     {!! Form::label('id_education_level', 'Tingkat Pendidikan', array('class' => 'col-sm-2 control-label')) !!}  <span class="required-input">*</span>
                <div class="col-sm-6">      
                    {!! Form::select('id_education_level', array('null' => 'Pilih Tingkat Pendidikan') + $list_education_level, Input::old('id_education_level'), array('class' => 'form-control valid') ) !!}
                </div>
              </div> 
               <div class="form-group">
