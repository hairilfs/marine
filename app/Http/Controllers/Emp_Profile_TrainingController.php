...
class Emp_Profile_TrainingController extends BaseController {
	...
	*/
    ...
    { 
		...
		return View::make('emp_profile_training.index')->with('data',$data);
	}

	public function view()
	{
		$data = Emp_Training::orderBy('id')->get();		
		return View::make('emp_profile_training.view')->with('data',$data);
	}
    /**
    ...
    */
    public function add($employee_profile_id)
    {
        ...
        return View::make('emp_profile_training.add')->with('list_status', $list_status)->with('list_training_type', $list_training_type)->with('employee_profile_id', $employee_profile_id);
    }
	/**
	...
	*/
	public function save()
	{
        ...
        if ($validator->fails()) {
            ...
            $emp_training_id = DB::getPdo()->lastInsertId();            

            // return Redirect::to('/emp_profile_training')->with('success', 'Data tersimpan.');
    ...
    */
    public function edit($id, $employee_profile_id)
    {
        ...
        $list_status = $this->get_list_status();
        if($data){            
            return View::make('emp_profile_training.edit')->with('data', $data)->with('list_status', $list_status)->with('list_training_type', $list_training_type)->with('employee_profile_id', $employee_profile_id);
        } else {
            return Redirect::action('Employee_ProfileController@edit_profile');
        }
    }
    ...
    */
    ...
    public function detail($id, $employee_profile_id){
        ...
        $list_training_type = Training_Type::orderBy('name')->lists('name', 'Id')->all();
        $list_status = $this->get_list_status();
        return View::make('emp_profile_training.detail')->with('data',$data)->with('list_status', $list_status)->with('list_training_type', $list_training_type)->with('employee_profile_id', $employee_profile_id);
    }
