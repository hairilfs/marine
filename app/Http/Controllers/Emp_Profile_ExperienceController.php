...
class Emp_Profile_ExperienceController extends BaseController {
	...
	*/
    ...
    { 
		...
		return View::make('emp_profile_experience.index')->with('data',$data);
	}

	public function view()
	{
		$data = Emp_Experience::orderBy('id')->get();		
		return View::make('emp_profile_experience.view')->with('data',$data);
	}
    /**
    ...
    */
    public function add($employee_profile_id)
    {
        ...
        return View::make('emp_profile_experience.add')->with('list_status', $list_status)->with('employee_profile_id', $employee_profile_id);
    }
	/**
    ...
    */
    public function edit($id, $employee_profile_id)
    {
        ...
        $list_status = $this->get_list_status();
        if($data){            
            return View::make('emp_profile_experience.edit')->with('data', $data)->with('list_status', $list_status)->with('employee_profile_id', $employee_profile_id);
        } else {
            return Redirect::action('Employee_ProfileController@edit_profile');
        }
    }
    ...
    */
    ...
    public function detail($id, $employee_profile_id){
        ...
        $data = Emp_Experience::find($id);
        $list_status = $this->get_list_status();
        return View::make('emp_profile_experience.detail')->with('data',$data)->with('list_status', $list_status)->with('employee_profile_id', $employee_profile_id);
    }
