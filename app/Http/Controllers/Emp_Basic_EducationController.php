...
class Emp_Basic_EducationController extends BaseController {
	...
	*/
    ...
    { 
		...
		return View::make('emp_basic_education.index')->with('data',$data);
	}

	public function view()
	{
		$data = Emp_Basic_Education::orderBy('id')->get();		
		return View::make('emp_basic_education.view')->with('data',$data);
	}
    /**
    ...
    */
    public function add($employee_profile_id)
    {
        ...
        return View::make('emp_basic_education.add')->with('list_status', $list_status)->with('list_level_basic_education', $list_level_basic_education)->with('employee_profile_id', $employee_profile_id);
    }
	/**
	...
	*/
	public function save()
	{
        ...
        if ($validator->fails()) {
            ...
            // return Redirect::to('/emp_basic_education')->with('success', 'Data tersimpan.');
    ...
    */
    public function edit($id, $employee_profile_id)
    {
        ...
        $list_status = $this->get_list_status();
        if($data){            
            return View::make('emp_basic_education.edit')->with('data', $data)->with('list_status', $list_status)->with('list_level_basic_education', $list_level_basic_education)->with('employee_profile_id', $employee_profile_id);
        } else {
            // return Redirect::action('Emp_Basic_EducationController@index');
            return Redirect::action('Employee_ProfileController@edit', array('id' => $employee_profile_id));
        }
    }
    /**
    ...
    */
    ...
    public function detail($id, $employee_profile_id){
        ...
        $list_level_basic_education = $this->get_list_level_basic_education();
        $list_status = $this->get_list_status();
        return View::make('emp_basic_education.detail')->with('data',$data)->with('list_status', $list_status)->with('list_level_basic_education', $list_level_basic_education)->with('employee_profile_id', $employee_profile_id);
    }
