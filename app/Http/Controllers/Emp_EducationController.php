...
class Emp_EducationController extends BaseController {
	...
	*/
    ...
    { 
		...
		return View::make('emp_education.index')->with('data',$data);
	}

	public function view()
	{
		$data = Emp_Education::orderBy('id')->get();		
		return View::make('emp_education.view')->with('data',$data);
	}
    /**
    ...
    */
    public function add($employee_profile_id)
    {
        ...
        return View::make('emp_education.add')->with('list_status', $list_status)->with('list_university', $list_university)->with('list_faculty', $list_faculty)->with('list_major', $list_major)->with('list_education_level', $list_education_level)->with('employee_profile_id', $employee_profile_id);
    }
	/**
	...
	*/
	public function save()
	{
        ...
        if ($validator->fails()) {
            ...
            // return Redirect::to('/emp_education')->with('success', 'Data tersimpan.');
    ...
    */
    public function edit($id, $employee_profile_id)
    {
        ...
        $list_status = $this->get_list_status();
        if($data){            
            return View::make('emp_education.edit')->with('data', $data)->with('list_status', $list_status)->with('list_university', $list_university)->with('list_faculty', $list_faculty)->with('list_major', $list_major)->with('list_education_level', $list_education_level)->with('employee_profile_id', $employee_profile_id);
        } else {
            // return Redirect::action('Emp_EducationController@index');
            return Redirect::action('Employee_ProfileController@edit', array('id' => $employee_profile_id));
        }
    }
    /**
    ...
    */
    ...
    public function detail($id, $employee_profile_id){
        ...
        $list_education_level = Education_level::orderBy('name')->lists('name', 'Id')->all();
        $list_status = $this->get_list_status();
        return View::make('emp_education.detail')->with('data',$data)->with('list_status', $list_status)->with('list_university', $list_university)->with('list_faculty', $list_faculty)->with('list_major', $list_major)->with('list_education_level', $list_education_level)->with('employee_profile_id', $employee_profile_id);
    }
